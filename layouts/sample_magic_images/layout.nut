...
local playerImage = fe.add_image("[!players]", 50, 175, 100, 100)
local genreImage = fe.add_image("[!genre]", 175, 175, 100, 100)
local regionImage = fe.add_image("[!region]", 300, 175, 100, 100)
local esrbImage = fe.add_image("[!esrb]", 425, 175, 100, 100)
local systemImage = fe.add_image("[!system]", 550, 175, 100, 100)
