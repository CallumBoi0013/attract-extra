...
class ExampleAnimation extends ExtendedAnimation {
    ...
    constructor(config) {
        ...
        local resources = [];
        resources.append(fe.add_image("extended/animations/example/invader.png", -32, -32, 32, 32));
        resources.append(fe.add_image("extended/animations/example/invader2.png", -32, -32, 32, 32));
        resources.append(fe.add_image("extended/animations/example/invader3.png", -32, -32, 32, 32));
